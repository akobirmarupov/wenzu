  ...
  return `
    <a class="card card-link biz-card" href="${ROUTES.detail(business.id)}">
      <div class="biz-card-media">
        ...
        ${business.rating_avg ? `<span class="rating-badge">${icon("star", { fill: true })} ${Number(business.rating_avg).toFixed(1)}</span>` : ""}
      ...
      <div class="card-body">
        ...
        ${business.address ? `<span class="addr">${icon("mapPin")} ${esc(business.address)}</span>` : ""}
        <div class="foot">
