...
const QUICK_LINKS = [
  { href: "/boshqaruv/arizalar/", icon: "document", title: "Arizalar", text: "Yangi bizneslarni tasdiqlash" },
  { href: "/boshqaruv/bizneslar/", icon: "building", title: "Bizneslar", text: "Ko'rinish va bloklash" },
  { href: "/boshqaruv/bronlar/", icon: "calendar", title: "Barcha bronlar", text: "Platforma bo'ylab qidirish" },
  { href: "/boshqaruv/obunalar/", icon: "gem", title: "Obunalar", text: "Faollashtirish va muddat" },
  { href: "/boshqaruv/tolovlar/", icon: "card", title: "To'lovlar", text: "Qo'lda kelgan to'lovlar" },
  { href: "/boshqaruv/kontent/", icon: "megaphone", title: "Kontent", text: "Banner va yangiliklar" },
];
...
async function loadStats() {
  ...
  try {
    ...
    $("#recent").innerHTML = data.recent_applications.length
      ...
      : emptyState("Arizalar yo'q", "Yangi biznes ariza berganda shu yerda ko'rinadi.", icon("document"));
  } catch (error) {
    render("#stats", "");
...
async function loadRecentReservations() {
  ...
  try {
    ...
    container.innerHTML = data.results.length
      ...
      : emptyState("Hozircha bron yo'q", "", icon("calendar"));
  } catch (error) {
