  ...
  try {
    ...
    render("#review-stats", `
      <div class="stat-card"><span class="label">O'rtacha reyting</span>
        <span class="value accent">${Number(overview.stats.rating_avg || 0).toFixed(1)} ${icon("star", { fill: true, className: "ico-gold" })}</span></div>
  ...
  try {
    ...
    $("#list").innerHTML = data.results.length
      ...
      : emptyState("Hozircha sharhlar yo'q",
          "Sharh faqat yakunlangan bronlar uchun qoldiriladi.", icon("star", { fill: true }));
