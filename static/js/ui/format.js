...
/**
 * 4.8 → beshta yulduz (to'ldirilgan/bo'sh).
 *
 * Chizishning o'zi `icons.js` da — nomi va imzosi shu yerda qoldi,
 * chunki uni o'nlab sahifa shu nom bilan chaqiradi.
 */
export function stars(rating) {
  return starRow(rating);
}
