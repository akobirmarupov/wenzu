...
class PageView(TemplateView):
    ...
    page_title = ""
    # Sarlavhaning tarjima kaliti.
    #
    # Sahifa nomi serverda o'zbekcha yoziladi va HTML bilan darhol
    # keladi — ekranda bo'sh joy ko'rinmaydi. Brauzerda esa `data-i18n`
    # bo'yicha tanlangan tilga almashadi. Kalitsiz sarlavha rus yoki
    # ingliz tilini tanlagan odamda ham o'zbekcha qolib ketardi.
    page_title_key = ""
    body_class = ""
    ...
    def get_context_data(self, **kwargs):
        ...
        context["page_title_key"] = self.page_title_key
...
class RestaurantListView(PageView):
    ...
    page_title_key = "nav.restaurants"
...
class OwnerSubscriptionView(PageView):
    ...
    page_title = "Obuna"
    page_title_key = "panel.subscription"
    body_class = "page-dashboard"
...
class AdminApplicationsView(PageView):
    ...
    page_title = "Arizalar"
    page_title_key = "panel.applications"
    body_class = "page-dashboard"
...
class AdminBusinessesView(PageView):
    ...
    page_title_key = "panel.businesses"
    body_class = "page-dashboard"
...
class AdminSubscriptionsView(PageView):
    ...
    page_title = "Obunalar"
    page_title_key = "panel.subscriptions"
    body_class = "page-dashboard"
...
class AdminReservationsView(PageView):
    ...
    page_title_key = "panel.allBookings"
    body_class = "page-dashboard"
...
class AdminSettingsView(PageView):
    ...
    page_title_key = "page.platformSettings"
    body_class = "page-dashboard"
