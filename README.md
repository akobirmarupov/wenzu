...
```bash
python manage.py reset_data        # nima o'chishini ko'rsatadi
python manage.py reset_data --yes  # o'chiradi
```
...
- **Redis yiqilsa sayt o'lmaydi** (`IGNORE_EXCEPTIONS`) — kesh chetlab
  o'tiladi, so'rov to'g'ridan-to'g'ri bazadan javob oladi.
