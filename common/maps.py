...
(mijoz ko'radigan tugmalar), egasining sozlamalar oqimida (kiritilgan
havoladan koordinatani chiqarish) va demo to'ldirgichda. Har birida
qaytadan yozilsa, bir kuni ular bir-biridan farq qila boshlardi.
"""
